...
void LogStreamBuffer::flush() {
    __asyncLogger.append(std::move(__buffer));
}
...
LogStream::LogStream(lsbuff_uptr_t _pBuffer): std::ostream(_pBuffer.get()), __buffer(_pBuffer) {}
